-- Job: NPS_AI_QUERY_TRANSACCIONES
-- Tabla: meli-bi-data.SBOX_NPS_ANALYTICS.TRANSACCIONES_SELLERS
-- Params: 2024-12-01 -> 2026-02-01 (YYYYMM: 202412 -> 202602)

CREATE OR REPLACE TABLE `meli-bi-data.SBOX_NPS_ANALYTICS.TRANSACCIONES_SELLERS` AS (
-- ============================================
...
WITH transacciones_sellers AS (
    ...
    WHERE
        m.TIM_DAY >= '2024-12-01'
        AND m.TIM_DAY < '2026-02-01'
